...
class HomeController < ApplicationController
	...
	layout @@tema
          ...
          def index
               ...
               @page = Txtbox.new
               @page.img = "freelancer/profile.png"
			   ...
			   @por = Portfolio.new
			   @por.item << {
			   	img: "freelancer/portfolio/cabin.png",
			   	titulo: "Site teste",
			   ...
			   @por.item << {
			   	img: "freelancer/portfolio/cake.png",
			   	titulo: "Site teste",
			   	txt: "Este é um teste muito legal",
			   	cliente_nome: "Fidelito",
			   	cliente_site: "fidelis.com",
			   ...
			   @por.item << {
			   	img: "freelancer/portfolio/circus.png",
			   	titulo: "Site teste",
			   	txt: "Este é um teste muito legal",
			   	cliente_nome: "Fidelito",
			   	cliente_site: "fidelis.com",
			   ...
			   @por.item << {
			   	img: "freelancer/portfolio/game.png",
			   	titulo: "Site teste",
			   	txt: "Este é um teste muito legal",
			   	cliente_nome: "Fidelito",
			   	cliente_site: "fidelis.com",
			   ...
			   @por.item << {
			   	img: "freelancer/portfolio/safe.png",
			   	titulo: "Site teste",
			   	txt: "Este é um teste muito legal",
			   	cliente_nome: "Fidelito",
			   	cliente_site: "fidelis.com",
			   ...
			   @por.item << {
			   	img: "freelancer/portfolio/submarine.png",
			   	titulo: "Site teste",
			   	txt: "Este é um teste muito legal",
			   	cliente_nome: "Fidelito",
			   	cliente_site: "fidelis.com",
